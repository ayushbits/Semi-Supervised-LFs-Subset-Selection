...
test_objs = load_pickle("Data/YOUTUBE/test_processed.p")
train_objs = load_pickle("Data/YOUTUBE/d_processed.p")
u_objs = load_pickle("Data/YOUTUBE/U_processed.p")
...
optimizer = torch.optim.Adam([{"params": lr_model.parameters()}, {"params": [pi, pi_y, theta]}], lr=0.0003)
...
#     probs_lr.clone().detach()
#     loss_6 = kl_divergence(probs_graphical, probs_lr)
    
#     loss = loss_6 + loss_4 +loss_1 + loss_3 #+ prec_loss# + loss_3 + loss_4 
#     #loss = loss_5+ loss_4#+loss_2 #+  loss_3# + prec_loss
#     #print(loss)
#     loss.backward()
#     optimizer.step()
...
#     gm_acc = accuracy_score(y_true_test, y_pred)
#     gm_mac = f1_score(y_true_test, y_pred, average="macro")
#     highep = epoch
#     #print("Epoch: {}\tGM - f1_score: {}".format(epoch, gm_mac))
#     #print("Epoch: {}\tGM - Accuracy: {}".format(epoch, gm_acc))
    
#     if (gm_acc < accuracy_score(y_true_test, y_pred)):
#         gm_acc = accuracy_score(y_true_test, y_pred)
#         gm_mac = f1_score(y_true_test, y_pred, average="macro")
#         highep = epoch
...
#     if (lr_acc < accuracy_score(y_true_test, y_pred)):
#         lr_acc = accuracy_score(y_true_test, y_pred)
#         lr_mac = f1_score(y_true_test, y_pred, average="macro")
#         highep = epoch
#         print(lr_mac, lr_acc, epoch)
