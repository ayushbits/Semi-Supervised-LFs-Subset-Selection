mkdir -p audit_rand
mkdir -p audit_rand/l134
CUDA_VISIBLE_DEVICES=0 python audit_rand_sub_selection.py audit_rand/l134 l1 0 l3 l4 0 0 0 5 datasets/audit > audit_rand/l134/res.txt
mkdir -p audit_rand/l1234
